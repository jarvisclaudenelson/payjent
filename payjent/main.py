...
def _landing_page_html(settings: Settings) -> str:
    ...
    return f"""<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>Payjent — payment-gate agent actions</title><meta name='description' content='Payjent is the payment checkpoint every serious agent needs before it spends, unlocks, or fulfills premium work.'><style>
:root{{--bg:#050711;--panel:#0b1020cc;--line:#ffffff1c;--text:#f7fbff;--muted:#9fb0c8;--cyan:#67e8f9;--violet:#a78bfa;--green:#86efac;--amber:#fde68a}}*{{box-sizing:border-box}}html{{scroll-behavior:smooth}}body{{margin:0;background:radial-gradient(circle at 20% 0%,#172554 0,#050711 34%),linear-gradient(180deg,#050711,#080b14 55%,#02040a);color:var(--text);font-family:Inter,ui-sans-serif,system-ui,-apple-system,Segoe UI,sans-serif;overflow-x:hidden}}body:before{{content:"";position:fixed;inset:0;pointer-events:none;background:linear-gradient(115deg,transparent,#67e8f91a,transparent,#a78bfa18,transparent);background-size:300% 300%;animation:sheen 18s linear infinite}}a{{color:inherit}}.nav{{position:sticky;top:0;z-index:10;backdrop-filter:blur(20px);background:#050711b8;border-bottom:1px solid var(--line)}}.navin{{max-width:1180px;margin:auto;padding:14px 20px;display:flex;align-items:center;justify-content:space-between;gap:16px}}.brand{{font-weight:900;letter-spacing:-.04em;text-decoration:none}}.brand:before{{content:"";display:inline-block;width:12px;height:12px;margin-right:9px;border-radius:50%;background:radial-gradient(circle,#fff,var(--cyan));box-shadow:0 0 30px var(--cyan)}}.navlinks{{display:flex;gap:18px;align-items:center;color:var(--muted);font-size:14px}}.btn{{display:inline-flex;align-items:center;gap:9px;border:1px solid #ffffff24;border-radius:999px;padding:11px 16px;text-decoration:none;font-weight:800;background:#ffffff0d;box-shadow:0 10px 40px #0006}}.btn.primary{{background:linear-gradient(135deg,#fff,#b8f3ff 45%,#c4b5fd);color:#06111f;border:0}}.hero{{max-width:1180px;margin:auto;padding:86px 20px 72px;display:grid;grid-template-columns:minmax(0,.95fr) minmax(420px,1.05fr);gap:48px;align-items:center}}.hero-copy{{max-width:760px}}.eyebrow{{color:var(--cyan);font-weight:900;text-transform:uppercase;letter-spacing:.16em;font-size:12px}}h1{{font-size:clamp(42px,6.9vw,84px);line-height:.93;letter-spacing:-.07em;margin:16px 0 22px;max-width:780px}}h1 .nowrap{{white-space:nowrap}}h2{{font-size:clamp(34px,5vw,64px);letter-spacing:-.055em;line-height:.95;margin:0 0 16px}}p{{color:var(--muted);font-size:18px;line-height:1.65}}.cta,.metrics{{display:flex;gap:12px;flex-wrap:wrap;margin-top:24px}}.metric,.card{{border:1px solid var(--line);border-radius:24px;background:linear-gradient(180deg,#ffffff12,#ffffff08);box-shadow:0 22px 70px #0007,inset 0 1px #fff2}}.metric{{padding:14px 16px;color:var(--muted);min-width:132px}}.metric b{{display:block;color:#fff;font-size:22px}}.stage{{min-height:540px;position:relative;border:1px solid #ffffff22;border-radius:34px;overflow:hidden;background:radial-gradient(circle at 50% 45%,#67e8f922,transparent 28%),linear-gradient(145deg,#0f172add,#050711);box-shadow:0 40px 110px #000b,inset 0 1px #fff3;transform:translateY(calc(var(--scroll-depth,0)*-8px))}}.stage:before{{content:"";position:absolute;inset:-25%;background:conic-gradient(from 130deg,transparent,#67e8f933,transparent,#a78bfa30,transparent);animation:spin 24s linear infinite}}.spine{{position:absolute;left:50%;top:52px;bottom:52px;width:1px;background:linear-gradient(var(--cyan),#ffffff22,var(--green));box-shadow:0 0 26px #67e8f988}}.gate-card{{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:162px;height:162px;border-radius:36px;display:grid;place-items:center;text-align:center;font-weight:950;letter-spacing:.08em;color:#06111f;background:linear-gradient(135deg,#f8fafc,#67e8f9,#a78bfa);box-shadow:0 0 70px #67e8f966;z-index:2}}.packet{{position:absolute;z-index:3;width:242px;border:1px solid #ffffff24;border-radius:22px;padding:16px;background:#07111fe8;backdrop-filter:blur(18px);box-shadow:0 24px 70px #0008;transition:transform .25s ease}}.packet small,.chip{{font-size:11px;font-weight:950;letter-spacing:.13em;color:var(--cyan);text-transform:uppercase}}.packet h3{{margin:7px 0 4px;font-size:18px}}.packet p{{font-size:13px;margin:0;line-height:1.4}}.chip{{display:inline-flex;margin-top:11px;padding:6px 9px;border-radius:999px;border:1px solid #ffffff22;background:#ffffff12;color:#dffbff}}.p1{{left:28px;top:54px}}.p2{{right:28px;top:188px}}.p3{{left:34px;bottom:56px}}.ray{{position:absolute;height:2px;background:linear-gradient(90deg,transparent,var(--cyan),transparent);filter:drop-shadow(0 0 8px var(--cyan));opacity:.8;animation:pulse 2.8s ease-in-out infinite}}.r1{{left:190px;top:168px;width:220px;transform:rotate(22deg)}}.r2{{right:188px;top:287px;width:190px;transform:rotate(-13deg)}}.r3{{left:205px;bottom:152px;width:225px;transform:rotate(-19deg)}}.story,.loop,.trust,.dashboard-moment{{max-width:1180px;margin:auto;padding:78px 20px;position:relative}}.story:before,.loop:before,.dashboard-moment:before{{content:"";position:absolute;left:20px;right:20px;top:0;height:1px;background:linear-gradient(90deg,transparent,#ffffff2c,transparent)}}.grid{{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-top:28px}}.card{{padding:22px}}.card h3{{margin:0 0 8px}}.step{{display:grid;grid-template-columns:70px 1fr;gap:18px;align-items:start;margin:20px 0;padding:20px;border:1px solid #ffffff18;border-radius:24px;background:#ffffff08}}.num{{width:54px;height:54px;border-radius:18px;display:grid;place-items:center;background:#67e8f91a;color:var(--cyan);font-weight:950}}.mock{{display:grid;grid-template-columns:1fr 1.15fr;gap:18px;align-items:stretch}}.panel{{border:1px solid #ffffff1e;border-radius:28px;background:linear-gradient(180deg,#101827,#070b14);padding:20px;box-shadow:0 30px 90px #0008}}.event{{padding:14px 0;border-bottom:1px solid #ffffff12}}.status{{float:right;border-radius:999px;padding:5px 9px;font-size:12px;font-weight:900;background:#052e1a;color:var(--green)}}[data-reveal]{{opacity:0;transform:translateY(24px) scale(.985);transition:opacity .7s ease,transform .7s cubic-bezier(.2,.8,.2,1)}}[data-reveal].is-visible{{opacity:1;transform:none}}[data-reveal='left']{{transform:translateX(-28px)}}[data-reveal='right']{{transform:translateX(28px)}}@keyframes sheen{{to{{background-position:300% 0}}}}@keyframes spin{{to{{transform:rotate(360deg)}}}}@keyframes pulse{{50%{{opacity:.25;transform:scaleX(.84) rotate(var(--rot,0deg))}}}}@media (max-width:900px){{.hero,.mock{{grid-template-columns:1fr}}.hero{{padding-top:58px}}.stage{{min-height:500px}}.grid{{grid-template-columns:1fr}}.navlinks a:not(.btn){{display:none}}h1 .nowrap{{white-space:normal}}}}@media (max-width:560px){{h1{{font-size:clamp(40px,15vw,58px)}}.packet{{width:210px}}.p1{{left:16px}}.p2{{right:16px}}.p3{{left:20px}}}}@media (prefers-reduced-motion:reduce){{html{{scroll-behavior:auto}}*,*:before{{animation:none!important;transition:none!important}}[data-reveal]{{opacity:1!important;transform:none!important}}}}
</style></head><body><nav class='nav'><div class='navin'><a class='brand' href='/'>Payjent</a><div class='navlinks'><a href='#loop'>Loop</a><a href='#trust'>Trust</a><a href='/dashboard'>Dashboard</a><a class='btn primary' href='{primary}'>Register your agent</a></div></div></nav><main><section class='hero'><div class='hero-copy' data-reveal='left'><div class='eyebrow'>Payment checkpoint for autonomous work</div><h1>Payment-gate agent actions. <span class='nowrap'>Resume after payment.</span></h1><p>Payjent is the payment gate for agent actions: a human authorizes an agent, the agent creates a paid action for premium data, APIs, or pay.sh-style work, the user pays through Payjent, and the agent resumes the exact stored request with a receipt trail.</p><div class='cta'><a class='btn primary' href='{primary}'>Register your agent →</a><a class='btn' href='/docs/agent-payjent-self-setup.md'>Teach your agent Payjent</a></div><div class='metrics'><div class='metric'><b>Gate</b>Before spend</div><div class='metric'><b>Resume</b>Exact request</div><div class='metric'><b>Prove</b>Receipt trail</div></div></div><div class='stage' data-reveal='right' data-depth aria-label='Request packet flowing through Payjent into a signed grant'><div class='spine'></div><div class='ray r1'></div><div class='ray r2'></div><div class='ray r3'></div><div class='packet p1'><small>01 · REQUEST PACKET</small><h3>Premium weather API</h3><p>agent_action.create · $1.50 · user consent required</p><span class='chip'>status: awaiting_payment</span></div><div class='packet p2'><small>02 · PAYJENT GATE</small><h3>Stored execution envelope</h3><p>Hash, callback, amount, user, agent, idempotency.</p><span class='chip'>checkpoint locked</span></div><div class='packet p3'><small>03 · SIGNED GRANT</small><h3>Resume exact request</h3><p>Receipt + payment_token unlock only the original action.</p><span class='chip'>ready_to_execute</span></div><div class='gate-card'>PAYJENT<br>GATE</div></div></section><section class='story' data-reveal><div class='eyebrow'>Why every serious agent needs it</div><h2>Agents need a checkpoint before they spend, unlock, or fulfill premium work.</h2><div class='grid'><div class='card'><h3>Without a gate</h3><p>Agents improvise payment links, lose request context, or execute expensive actions before consent.</p></div><div class='card'><h3>With Payjent</h3><p>Every premium action becomes a signed, auditable checkpoint: request → payment → grant → fulfillment.</p></div><div class='card'><h3>Built for operators</h3><p>Dashboard access stays protected while agents use scoped credentials and verifiable grants.</p></div></div></section><section class='loop' id='loop'><div class='eyebrow' data-reveal>Loop</div><h2 data-reveal>One clean motion: ask, gate, pay, resume.</h2><div class='step' data-reveal><div class='num'>1</div><div><h3>Agent asks for paid work</h3><p>Payjent stores the execution envelope and creates a checkout instead of letting the agent spend first.</p></div></div><div class='step' data-reveal><div class='num'>2</div><div><h3>Human pays the checkpoint</h3><p>The browser sees a payment session and status, not secrets or operator-only mock completion controls.</p></div></div><div class='step' data-reveal><div class='num'>3</div><div><h3>Agent resumes from a signed grant</h3><p>The grant verifies bot, user, request hash, amount, and expiry before any fulfillment or downstream spend.</p></div></div></section><section class='dashboard-moment' data-reveal><div class='mock'><div><div class='eyebrow'>Dashboard moment</div><h2>Operators see the exact paid-action trail.</h2><p>A concrete command-center pattern: real quotes and spend entries appear when present; empty states are explicit rather than invented.</p></div><div class='panel'><div class='event'><span class='status'>paid</span><b>Premium API unlock</b><br><span class='muted'>$1.50 USD · request_hash verified</span></div><div class='event'><span class='status'>grant</span><b>payment_token issued</b><br><span class='muted'>bot_id + external_user_id bound</span></div><div class='event'><span class='status'>resume</span><b>execution envelope released</b><br><span class='muted'>agent continues the stored request</span></div></div></div></section><section class='trust' id='trust' data-reveal><div class='eyebrow'>Trust surface</div><h2>Payment, identity, and execution stay separated.</h2><div class='grid'><div class='card'><h3>Scoped credentials</h3><p>Agents can only act within their bot scope unless an operator credential is used.</p></div><div class='card'><h3>Fail-closed rails</h3><p>Payjent does not execute downstream pay.sh; experimental rails do not issue receipts or grants until settlement is explicitly mapped.</p></div><div class='card'><h3>Protected dashboard</h3><p>The operator dashboard remains behind WorkOS or fallback account auth.</p></div></div><div class='cta'><a class='btn primary' href='{primary}'>Register your agent</a><a class='btn' href='/dashboard'>Open dashboard</a></div></section></main><script>
(()=>{{const reduce=matchMedia('(prefers-reduced-motion: reduce)').matches;const items=[...document.querySelectorAll('[data-reveal]')];if(reduce){{items.forEach(el=>el.classList.add('is-visible'));return}}const io=new IntersectionObserver(es=>es.forEach(e=>{{if(e.isIntersecting){{e.target.classList.add('is-visible');io.unobserve(e.target)}}}}),{{threshold:.16,rootMargin:'0px 0px -8% 0px'}});items.forEach(el=>io.observe(el));const depth=[...document.querySelectorAll('[data-depth]')];let ticking=false;const onScroll=()=>{{if(ticking)return;ticking=true;requestAnimationFrame(()=>{{const vh=innerHeight;depth.forEach(el=>{{const r=el.getBoundingClientRect();const v=Math.max(-1,Math.min(1,(vh/2-(r.top+r.height/2))/vh));el.style.setProperty('--scroll-depth',v.toFixed(3))}});ticking=false}})}};addEventListener('scroll',onScroll,{{passive:true}});onScroll();}})();
</script></body></html>"""
...
body{margin:0;font-family:Inter,ui-sans-serif,system-ui;color:#eef6ff;background:radial-gradient(circle at 15% -10%,#1d4ed8 0,#07111f 35%,#030712 75%)}a{color:#8be9ff}main{max-width:1220px;margin:auto;padding:32px 20px}.hero{padding:34px;border:1px solid #ffffff1c;border-radius:30px;background:linear-gradient(135deg,#ffffff12,#ffffff08);box-shadow:0 30px 90px #0008,inset 0 1px #fff2}.eyebrow{color:#67e8f9;font-weight:900;text-transform:uppercase;letter-spacing:.14em}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:18px;margin-top:22px}.card{background:linear-gradient(180deg,#0f172acc,#0b1020cc);border:1px solid #ffffff18;border-radius:22px;padding:20px;box-shadow:0 18px 60px #0005}.pill{display:inline-flex;border-radius:999px;padding:5px 10px;font-size:12px;font-weight:800;background:#172554;color:#93c5fd}.ok{background:#052e1a;color:#86efac}.warn{background:#3a2a05;color:#fde68a}pre{overflow:auto;background:#020617;color:#dbeafe;border:1px solid #ffffff12;border-radius:16px;padding:16px}.muted{color:#a8b3c7}.btn,button{display:inline-block;background:linear-gradient(135deg,#f8fafc,#a5f3fc,#c4b5fd);color:#06111f;text-decoration:none;border:0;border-radius:999px;padding:10px 14px;font-weight:850;cursor:pointer}.topbar{display:flex;justify-content:space-between;align-items:center;margin-bottom:18px}.logout{background:#ffffff0d;color:#dbeafe;border:1px solid #ffffff24}.auth-wrap{min-height:100vh;display:grid;place-items:center;padding:24px;background:radial-gradient(circle at 80% 0,#7c3aed55,transparent 36%)}.auth-card{width:min(480px,100%);background:linear-gradient(180deg,#0f172aee,#050711ee);border:1px solid #ffffff1c;border-radius:28px;padding:30px;box-shadow:0 34px 100px #000b}.error{background:#450a0a;color:#fecaca;border:1px solid #ef4444;border-radius:12px;padding:10px 12px;margin:12px 0}label{display:block;font-weight:800;margin-top:12px}input{width:100%;box-sizing:border-box;border:1px solid #ffffff24;color:#eef6ff;border-radius:12px;padding:12px;margin:6px 0 12px;background:#020617}.fine{font-size:13px;color:#9fb0c8;line-height:1.5}.stat{font-size:34px;font-weight:900;letter-spacing:-.04em}.timeline{display:grid;gap:10px}.event{padding:14px;border-left:2px solid #67e8f9;background:#ffffff08;border-radius:14px}@media(max-width:650px){main{padding:18px}.hero{padding:22px}}@media (prefers-reduced-motion: reduce){*,*:before,*:after{scroll-behavior:auto!important;animation-duration:.001ms!important;animation-iteration-count:1!important;transition-duration:.001ms!important}}
</style>"""
...
def dashboard(request: Request, session: Session = Depends(get_session), settings: Settings = Depends(get_settings)):
    ...
    cards = "".join(f"<div class='card' data-agent-id='{_html_escape(a.id)}'><span class='pill'>{_html_escape(a.platform)}</span><h3>{_html_escape(a.name)}</h3><p class='muted'><code>{_html_escape(a.bot_id)}</code></p><p><a class='btn' href='/dashboard/agents/{_html_escape(a.id)}'>Open command view</a></p></div>" for a in agents) or "<div class='card'><h3>No agents yet</h3><p class='muted'>Register via the operator-authenticated API below. The dashboard will stay empty rather than inventing agent activity.</p></div>"
