...
def _landing_page_html(settings: Settings) -> str:
    ...
    return f"""<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>Payjent — payment-gated agent actions</title><meta name='description' content='Payment-gate agent actions. Store the request, collect human payment, issue a signed grant, and let the agent resume exactly once.'><style>
