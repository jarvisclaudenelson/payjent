...
def _landing_page_html(settings: Settings) -> str:
    ...
    return f"""<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>Payjent — payment-gated agent actions</title><meta name='description' content='Payment-gate agent actions. Payjent is the human-approved checkpoint before paid agent work resumes, not an x402 API-payment framework.'><style>
:root{{--bg:#fbfbfd;--surface:#f5f5f7;--ink:#1d1d1f;--muted:#6e6e73;--line:#d2d2d7;--blue:#0071e3}}*{{box-sizing:border-box}}html{{scroll-behavior:smooth}}body{{margin:0;background:var(--bg);color:var(--ink);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}}a{{color:var(--blue);text-decoration:none}}a:hover{{text-decoration:underline}}.nav{{position:sticky;top:0;z-index:5;background:rgba(251,251,253,.88);backdrop-filter:saturate(180%) blur(20px)}}.navin{{max-width:1120px;margin:0 auto;padding:16px 22px;display:flex;align-items:center;justify-content:space-between;gap:20px}}.brand{{color:var(--ink);font-weight:600;letter-spacing:-.02em}}.navlinks{{display:flex;align-items:center;gap:24px;font-size:14px;color:var(--muted)}}.btn{{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:0 22px;border-radius:999px;color:var(--blue);font-weight:600;text-decoration:none;white-space:nowrap}}.btn.primary{{background:var(--blue);color:white}}.btn:hover{{text-decoration:none}}main{{overflow:hidden}}.hero{{max-width:1120px;margin:0 auto;padding:104px 22px 72px;display:grid;grid-template-columns:minmax(0,1.05fr) minmax(280px,.95fr);gap:84px;align-items:center}}.eyebrow{{font-size:13px;line-height:1.4;color:var(--muted);font-weight:600;letter-spacing:.02em;margin-bottom:18px}}h1{{font-size:clamp(48px,8vw,92px);line-height:.94;letter-spacing:-.07em;margin:0 0 28px;max-width:850px;font-weight:700}}h1 em{{font-style:normal;color:var(--muted);font-weight:600}}h2{{font-size:clamp(34px,5vw,64px);line-height:1;letter-spacing:-.055em;margin:0 0 18px}}h3{{font-size:22px;line-height:1.14;letter-spacing:-.035em;margin:0 0 10px}}p{{font-size:20px;line-height:1.45;letter-spacing:-.022em;margin:0;color:var(--muted)}}.hero p{{max-width:650px}}.cta{{display:flex;gap:12px;flex-wrap:wrap;margin-top:34px}}.sequence{{padding:12px 0 0}}.step{{padding:28px 0;border-top:1px solid var(--line)}}.step:first-child{{border-top:0}}.step b{{display:block;font-size:14px;color:var(--muted);font-weight:600;margin-bottom:9px}}.step strong{{display:block;font-size:30px;line-height:1.03;letter-spacing:-.045em;margin-bottom:10px}}.step span{{display:block;color:var(--muted);font-size:17px;line-height:1.5}}.sections{{max-width:1120px;margin:0 auto;padding:40px 22px 96px}}.open{{padding:80px 0;border-top:1px solid var(--line);display:grid;grid-template-columns:.75fr 1.25fr;gap:70px}}.open ul{{list-style:none;margin:0;padding:0}}.open li{{font-size:22px;line-height:1.35;letter-spacing:-.03em;padding:18px 0;border-top:1px solid var(--line)}}.open li:first-child{{border-top:0}}.small{{font-size:15px;line-height:1.5;color:var(--muted)}}.diagram{{margin-top:42px;display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:var(--line)}}.diagram div{{background:var(--bg);padding:28px 18px;min-height:138px}}.diagram b{{display:block;font-size:13px;color:var(--muted);margin-bottom:24px}}.diagram span{{font-size:19px;line-height:1.18;letter-spacing:-.03em}}footer{{max-width:1120px;margin:0 auto;padding:0 22px 44px;color:var(--muted);font-size:13px}}@media(max-width:820px){{.navlinks a:not(.primary){{display:none}}.navin{{padding:14px 18px}}.hero{{grid-template-columns:1fr;gap:42px;padding:72px 18px 48px}}.sections{{padding:18px 18px 70px}}.open{{grid-template-columns:1fr;gap:28px;padding:58px 0}}.diagram{{grid-template-columns:1fr;background:transparent;gap:0}}.diagram div{{border-top:1px solid var(--line);padding:24px 0;min-height:0}}h1{{font-size:clamp(46px,15vw,70px)}}p{{font-size:18px}}.cta .btn{{width:100%}}}}
</style></head><body><nav class='nav'><div class='navin'><a class='brand' href='/'>Payjent</a><div class='navlinks'><a href='#flow'>Flow</a><a href='#trust'>Trust</a><a href='/dashboard'>Dashboard</a><a class='btn primary' href='{primary}'>Register your agent</a></div></div></nav><main><section class='hero'><div><div class='eyebrow'>Payment-gated autonomy</div><h1>Payment-gate agent actions.</h1><p>Payjent is the human-approved checkpoint for paid agent work. x402 helps agents pay APIs automatically; Payjent helps agents ask a person to approve and pay before the exact action resumes once.</p><div class='cta'><a class='btn primary' href='{primary}'>Register your agent</a><a class='btn' href='/docs/agent-payjent-self-setup.md'>Send setup guide</a></div></div><div class='sequence' aria-label='Payjent action flow'><div class='step'><b>01</b><strong>Request held</strong><span>The agent asks for a paid action. Payjent preserves the request and execution envelope.</span></div><div class='step'><b>02</b><strong>Human pays</strong><span>The paid-action checkpoint waits for approval and payment before anything resumes.</span></div><div class='step'><b>03</b><strong>Grant signed</strong><span>A signed grant unlocks the original action once. Payjent does not execute downstream pay.sh.</span></div></div></section><section class='sections'><div class='open'><div><div class='eyebrow'>Not just x402</div><h2>x402 helps agents pay APIs. Payjent helps agents ask humans to approve paid work.</h2></div><div><p>Payjent answers the operator question before spend resumes: <b>should this agent resume this exact paid action?</b></p><ul><li>x402 is useful rail infrastructure for API payments.</li><li>Payjent is the human approval airlock around agent-initiated paid work.</li><li>The checkout is bound to the stored request, amount, and execution envelope.</li></ul></div></div></section><section class='sections' id='flow'><div class='open'><div><div class='eyebrow'>The airlock</div><h2>One pause. One payment. One resume.</h2></div><div><ul><li>Gate human-approved agent work, not generic autonomous API spend.</li><li>Store the agent's intended action before spend.</li><li>Show the person exactly what they are approving.</li><li>Issue a receipt and signed grant after payment clears.</li><li>Resume the agent's original request, not a rewritten approximation.</li></ul></div></div><div class='open' id='trust'><div><div class='eyebrow'>Operator setup</div><h2>Built for a clear handoff.</h2></div><div><p>Use WorkOS, open Dashboard, Register agent, copy the one-time credential, store it privately as <code>X-Payjent-Bot-Key</code>, then send <a href='/docs/agent-payjent-self-setup.md'>/docs/agent-payjent-self-setup.md</a> to the agent.</p><div class='diagram'><div><b>WorkOS</b><span>Sign in.</span></div><div><b>Dashboard</b><span>Register your agent.</span></div><div><b>Credential</b><span>Copy once. Store privately.</span></div><div><b>Agent</b><span>Resume paid actions safely.</span></div></div></div></div></section></main><footer>Payjent gates payment and preserves the action trail. Secrets are never shown again after one-time credential creation.</footer></body></html>"""
...
:root{--bg:#fbfbfd;--surface:#f5f5f7;--ink:#1d1d1f;--muted:#6e6e73;--line:#d2d2d7;--blue:#0071e3;--bad:#b42318;--warn:#8a5a00}*{box-sizing:border-box}body{margin:0;min-height:100vh;background:var(--bg);color:var(--ink);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Text','SF Pro Display','Segoe UI',Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased}a{color:var(--blue);text-decoration:none}a:hover{text-decoration:underline}main{max-width:1120px;margin:0 auto;padding:26px 22px 88px}.topbar{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:72px;color:var(--muted);font-size:14px}.topbar form{margin:0}.logout{background:transparent;color:var(--blue);border:0;padding:12px 0;font:inherit;font-weight:600;cursor:pointer}.hero{padding:0 0 54px;border-bottom:1px solid var(--line);margin-bottom:46px}.eyebrow{font-size:13px;line-height:1.4;color:var(--muted);font-weight:600;letter-spacing:.02em;margin-bottom:14px}h1{font-size:clamp(42px,7vw,78px);line-height:.96;letter-spacing:-.065em;margin:0 0 18px;font-weight:700}h2{font-size:clamp(30px,4.5vw,52px);line-height:1;letter-spacing:-.05em;margin:72px 0 24px}h3{font-size:24px;line-height:1.12;letter-spacing:-.035em;margin:0 0 10px}.muted,p{color:var(--muted);line-height:1.48;letter-spacing:-.018em}.hero p{font-size:20px;max-width:880px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:36px 52px;margin-top:30px}.card{background:transparent;border:0;border-radius:0;padding:0;overflow:visible}.pill{display:inline-flex;align-items:center;min-height:28px;padding:0;color:var(--muted);font-size:13px;font-weight:600}.pill.ok{color:#1d7f3a}.pill.warn{color:var(--warn)}.stat{font-size:34px;line-height:1.08;letter-spacing:-.045em;margin:12px 0;color:var(--ink);font-weight:600}.event{padding:18px 0;border-top:1px solid var(--line)}.event:first-child{border-top:0}form{display:grid;gap:12px}label{font-size:14px;color:var(--muted);font-weight:600}input{width:100%;min-height:48px;border:0;border-radius:0;background:var(--surface);color:var(--ink);font:inherit;font-size:17px;padding:12px 14px;outline:0}input:focus{outline:2px solid var(--blue);outline-offset:0}button,.btn{display:inline-flex;align-items:center;justify-content:center;min-height:44px;border:0;border-radius:999px;background:var(--blue);color:white!important;padding:0 22px;font:inherit;font-weight:600;cursor:pointer;text-decoration:none;width:max-content;max-width:100%}pre{white-space:pre-wrap;word-break:break-word;background:var(--surface);color:var(--ink);padding:16px;border-radius:0;overflow:auto}code{font-family:'SF Mono',ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:.92em}.fine{font-size:13px;color:var(--muted);line-height:1.5}.warnbox,.error{color:var(--bad);background:transparent;border-left:2px solid var(--bad);padding:4px 0 4px 14px}.auth-wrap{min-height:100vh;display:grid;place-items:center;padding:34px 22px}.auth-card{width:min(100%,520px)}hr{border:0;border-top:1px solid var(--line);margin:28px 0}ol,ul{padding-left:22px}li{margin:10px 0;line-height:1.45}@media(max-width:720px){main{padding:20px 18px 70px}.topbar{margin-bottom:52px}.hero{padding-bottom:42px;margin-bottom:34px}.grid{grid-template-columns:1fr;gap:34px}button,.btn{width:100%;min-height:48px}.topbar .logout{width:auto}h2{margin-top:58px}.hero p{font-size:18px}}
</style>"""
