def test_create_valid_quote(client, quote_payload, bot_headers):
    r = client.post("/api/v1/quotes", json=quote_payload, headers=bot_headers)
...
def test_reject_amount_breakdown_mismatch(client, quote_payload, bot_headers):
